...
DROP TABLE IF EXISTS `subject-code-tbl`;
...
LOCK TABLES `subject-code-tbl` WRITE;
/*!40000 ALTER TABLE `subject-code-tbl` DISABLE KEYS */;
INSERT INTO `subject-code-tbl` VALUES ('CC101',''),('CC102',''),('CC103',''),('CC104',''),('DC105','DataScience'),('GE106','tetring');
/*!40000 ALTER TABLE `subject-code-tbl` ENABLE KEYS */;
UNLOCK TABLES;
